  ...
  return (
    <LayoutWrapper>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Welcome to Ayam Geybok Inventory Management System</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-gray-900">View Stock</h3>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">View stock analytics</p>
            </div>
          </a>
        </div>
      </div>
